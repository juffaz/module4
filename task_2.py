...
russlang = int(input("Введите кол-во баллов по русскому языку:"))
matematika = int(input("Введите кол-во баллов по математике:"))
informatika = int(input("Введите кол-во баллов по информатике:"))

if (russlang + matematika + informatika) >= 270:
